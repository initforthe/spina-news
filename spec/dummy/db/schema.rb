...
ActiveRecord::Schema.define(version: 20170616152118) do
  ...
  create_table "spina_news_articles", force: :cascade do |t|
    t.string   "title"
    t.text     "excerpt"
    t.text     "content"
    t.integer  "photo_id"
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["photo_id"], name: "index_spina_news_articles_on_photo_id"
    t.index ["slug"], name: "index_spina_news_articles_on_slug"
    t.index ["user_id"], name: "index_spina_news_articles_on_user_id"
  end
